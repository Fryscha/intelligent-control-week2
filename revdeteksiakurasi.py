...
with open('color_detection_results.csv', 'w', newline='') as csvfile:
    csvwriter = csv.writer(csvfile)
    csvwriter.writerow(['Timestamp', 'Color Name', 'Confidence Score'])  # Tulis header
    ...
    while True:
        ...
        # Tulis hasil deteksi ke file CSV
        csvwriter.writerow([timestamp, color_name, confidence_score])
        
        # Tampilkan hasil di terminal
        print(f"Timestamp: {timestamp}, Color: {color_name}, Confidence: {confidence_score}")
