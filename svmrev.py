...
csv_file = open('color_detection_log.csv', 'w', newline='')
...
try:
    while True:
        ...
        # Tulis ke file CSV
        csv_writer.writerow([timestamp, r, g, b, color_name])
        
        # Cetak ke terminal
        print(f"{timestamp} - RGB: ({r}, {g}, {b}) - Detected Color: {color_name}")
